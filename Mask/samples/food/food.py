...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_food_0027.h5")
...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        self.add_class("food", 1, "burger")
        self.add_class("food", 2, "french_fries")
        self.add_class("food", 3, "chicken")
        self.add_class("food", 4, "toast")
        self.add_class("food", 5, "egg")
        self.add_class("food", 6, "pizza")
        self.add_class("food", 7, "cookie")
        self.add_class("food", 8, "hot dog")
        self.add_class("food", 9, "steak")
        #self.add_class("food", 10, "donut")
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "allfoods.json")))
